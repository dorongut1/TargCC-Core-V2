...
/// <summary>
/// Tests for GenerateCqrsCommand.
/// </summary>
public class GenerateCqrsCommandTests
{
    ...
    public GenerateCqrsCommandTests()
    {
    ...
    {
        // Arrange & Act
        var command = new GenerateCqrsCommand(
            _mockLogger.Object,
        ...
        command.Name.Should().Be("cqrs");
        command.Description.Should().Contain("CQRS");
    }
    ...
    {
        // Arrange & Act
        var act = () => new GenerateCqrsCommand(
            null!,
            _mockConfigService.Object,
            _mockOutput.Object,
            _mockGenerationService.Object);
