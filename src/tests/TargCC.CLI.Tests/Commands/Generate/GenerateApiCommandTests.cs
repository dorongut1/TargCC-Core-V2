...
/// <summary>
/// Tests for GenerateApiCommand.
/// </summary>
public class GenerateApiCommandTests
{
    ...
    public GenerateApiCommandTests()
    {
    ...
    {
        // Arrange & Act
        var command = new GenerateApiCommand(
            _mockLogger.Object,
        ...
        command.Name.Should().Be("api");
        command.Description.Should().Contain("API");
    }
    ...
    {
        // Arrange & Act
        var act = () => new GenerateApiCommand(
            null!,
            _mockConfigService.Object,
            _mockOutput.Object,
            _mockGenerationService.Object);
