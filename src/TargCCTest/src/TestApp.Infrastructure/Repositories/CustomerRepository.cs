...
public class CustomerRepository : ICustomerRepository
{
    ...
    public async Task AddAsync(Customer entity, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            parameters.Add("@ent_CreditCard", entity.CreditCard);
            parameters.Add("@lkp_Status", entity.Status);
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<Order>> GetOrdersAsync(int customerId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Retrieved {Count} ORDERS for Customer ID: {CustomerId}", result.Count(), customerId);
