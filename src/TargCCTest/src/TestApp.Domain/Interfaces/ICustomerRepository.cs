...
public interface ICustomerRepository
{
    ...
    /// <summary>
    /// Fetches all orders for the specified customer.
    /// </summary>
    ...
    Task<IEnumerable<Order>> GetOrdersAsync(int customerId, int? skip = null, int? take = null, CancellationToken cancellationToken = default);
