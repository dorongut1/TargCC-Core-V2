...
namespace TargCC.Core.Generators.UI
{
    ...
    public class TypeScriptTypeGenerator : BaseUIGenerator
    {
        ...
        private static string GenerateCommonTypes()
        {
            var sb = new StringBuilder();

            // File header
            sb.AppendLine("// <auto-generated>");
            sb.AppendLine("//     This code was generated by TargCC TypeScript Type Generator.");
            ...
            sb.AppendLine(" * @template T The type of items in the result set");
            sb.AppendLine(" */");
            sb.AppendLine("export interface PagedResult<T> {");
            sb.AppendLine("  /** The list of items in the current page */");
            sb.AppendLine("  items: T[];");
            sb.AppendLine("  /** The total number of items across all pages */");
            sb.AppendLine("  totalCount: number;");
            sb.AppendLine("  /** The current page number (1-based) */");
            sb.AppendLine("  page: number;");
            sb.AppendLine("  /** The number of items per page */");
            sb.AppendLine("  pageSize: number;");
            sb.AppendLine("  /** The total number of pages */");
            sb.AppendLine("  totalPages: number;");
            sb.AppendLine("  /** Whether there is a previous page */");
            sb.AppendLine("  hasPreviousPage: boolean;");
            sb.AppendLine("  /** Whether there is a next page */");
            ...
            sb.AppendLine("/**");
            sb.AppendLine(" * Common pagination parameters.");
            sb.AppendLine(" */");
            sb.AppendLine("export interface PaginationParams {");
            sb.AppendLine("  /** Page number (1-based) */");
            sb.AppendLine("  page?: number;");
            sb.AppendLine("  /** Number of items per page */");
            sb.AppendLine("  pageSize?: number;");
            sb.AppendLine("  /** Field name to sort by */");
            sb.AppendLine("  sortBy?: string;");
            sb.AppendLine("  /** Sort direction */");
            sb.AppendLine("  sortDirection?: 'asc' | 'desc';");
            sb.AppendLine("}");
            sb.AppendLine();

            // UseEntityOptions interface (generic)
            sb.AppendLine("/**");
            sb.AppendLine(" * Options for entity query hooks.");
            sb.AppendLine(" * @template TFilters The type of filters for the entity");
            sb.AppendLine(" */");
            sb.AppendLine("export interface UseEntityOptions<TFilters> extends PaginationParams {");
            sb.AppendLine("  /** Filters to apply to the query */");
            sb.AppendLine("  filters?: TFilters;");
            sb.AppendLine("  /** Whether the query should be enabled (default: true) */");
