...
namespace TargCC.Core.Generators.API
{
    ...
    {
        private readonly ILogger<DashboardControllerGenerator> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardControllerGenerator"/> class.
        /// </summary>
        /// <param name="logger">Logger instance.</param>
        public DashboardControllerGenerator(ILogger<DashboardControllerGenerator> logger)
        {
        ...
        public string Generate(System.Collections.Generic.List<Table> tables, string rootNamespace)
        {
            ...
            GenerateControllerClass(sb, tableTables, rootNamespace);
        ...
        private static void GenerateDTOs(StringBuilder sb, System.Collections.Generic.List<Table> tables)
        {
            // DashboardStatsDto
        ...
        private static void GenerateControllerClass(StringBuilder sb, System.Collections.Generic.List<Table> tables, string rootNamespace)
        {
            sb.AppendLine();
            sb.AppendLine("    /// <summary>");
        ...
        private static void GenerateFields(StringBuilder sb, System.Collections.Generic.List<Table> tables)
        {
            foreach (var table in tables)
            {
                var className = GetClassName(table.Name);
        ...
        private static void GenerateConstructor(StringBuilder sb, System.Collections.Generic.List<Table> tables)
        {
            sb.AppendLine("        /// <summary>");
        ...
        private static void GenerateStatsEndpoint(StringBuilder sb, System.Collections.Generic.List<Table> tables)
        {
            sb.AppendLine("        /// <summary>");
