...
export const CustomerList: React.FC = () => {
  ...
  const columns: GridColDef<Customer>[] = [
    ...
    { field: 'creditCard', headerName: 'CreditCard', width: 150, filterable: true },
    { field: 'status', headerName: 'Status', width: 150, filterable: true, valueGetter: (_, row) => row.statusText || row.statusCode },
    {
      field: 'actions',
      type: 'actions',
      headerName: 'Actions',
