...
/// <summary>
/// Command to generate REST API controller for a database table.
/// </summary>
public class GenerateApiCommand : Command
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GenerateApiCommand"/> class.
    /// </summary>
    /// <param name="logger">Logger instance.</param>
    /// <param name="configService">Configuration service.</param>
    /// <param name="output">Output service.</param>
    /// <param name="generationService">Generation service.</param>
    public GenerateApiCommand(
        ILogger logger,
        IConfigurationService configService,
        IOutputService output,
        IGenerationService generationService)
        : base("api", "Generate REST API controller for a database table")
    {
        ...
        string? outputDirectory)
    {
        try
        {
            _output.Heading($"Generate API Controller: {tableName}");
            _output.BlankLine();
            ...
            await _output.SpinnerAsync(
                ...
                async () =>
                {
                    result = await _generationService.GenerateApiAsync(
                        connectionString,
                        tableName,
                        outputDirectory);
                });
        ...
        {
            _logger.LogError(ex, "Error in generate api command");
