                ...
                <Box display="flex" alignItems="center" gap={2}>
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" sx={{ color: 'lightgreen' }}>
                      +{stats?.customersGrowth || 0}% vs last month
                    </Typography>
                  </Box>
                </Box>
              </CardContent>
              ...
              <CardContent>
                <Box display="flex" alignItems="center" gap={2}>
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" sx={{ color: 'lightgreen' }}>
                      +{stats?.ordersGrowth || 0}% vs last month
                    </Typography>
                  </Box>
                </Box>
              </CardContent>
            ...
            <Card sx={{ bgcolor: '#FFC000', color: 'white' }}>
              <CardContent>
                <Box display="flex" alignItems="center" gap={2}>
                  ...
                  <Box>
                    <Typography variant="h4">{stats?.totalOrderItems || 0}</Typography>
                    <Typography variant="body1">Total OrderItems</Typography>
                    <Typography variant="caption" sx={{ color: 'lightgreen' }}>
                      +{stats?.orderItemsGrowth || 0}% vs last month
                    </Typography>
                  </Box>
                </Box>
              </CardContent>
