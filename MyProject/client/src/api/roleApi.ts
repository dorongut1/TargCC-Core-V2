...
export const roleApi = {
  ...
  /**
   * Get all Roles with server-side filtering, sorting, and pagination.
   */
  getAll: async (options?: UseRoleOptions): Promise<PagedResult<Role>> => {
    ...
    const response = await api.get<PagedResult<Role>>(`/Roles?${params.toString()}`);
    return response.data;
  },
