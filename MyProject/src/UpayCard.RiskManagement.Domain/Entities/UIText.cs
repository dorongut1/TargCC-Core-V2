...
namespace UpayCard.RiskManagement.Domain.Entities
{
    ...
    public partial class UIText
    {
        ...
        /// </summary>
        [Column("TableName_UIText")]
        public bool? TableName_UIText { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Returns a string representation of this UIText.
        /// </summary>
        public override string ToString()
        {
            return $"UIText #{ID}: {Name}";
        }

        /// <summary>
        /// Creates a shallow copy of this UIText.
        /// </summary>
        public UIText Clone()
        {
            return new UIText
            {
                TableName_UIText = this.TableName_UIText,
                Page = this.Page,
                Name = this.Name,
        ...
        /// <summary>
        /// Determines whether the specified object is equal to this UIText.
        /// </summary>
        public override bool Equals(object obj)
        {
            if (obj is not UIText other)
                return false;
