...
/// </summary>
public class CreateGovtReportDistributorHandler : IRequestHandler<CreateGovtReportDistributorCommand, Result<int>>
{
    ...
    /// <inheritdoc/>
    public async Task<Result<int>> Handle(CreateGovtReportDistributorCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            var entity = new GovtReportDistributor
            {
                ...
                enmReportS01EntityType_GovtReportEntityType = request.enmReportS01EntityType_GovtReportEntityType,
                enmReportS02EntityType_GovtReportEntityType = request.enmReportS02EntityType_GovtReportEntityType,
