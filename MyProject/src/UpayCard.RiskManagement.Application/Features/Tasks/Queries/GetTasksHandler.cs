...
public class GetTasksHandler : IRequestHandler<GetTasksQuery, Result<PagedResult<TaskDto>>>
{
    ...
    private static IQueryable<Task> ApplyFilters(IQueryable<Task> query, TaskFilters? filters)
    {
        if (filters == null)
        {
            return query;
    ...
    private static IQueryable<Task> ApplySorting(IQueryable<Task> query, string? sortBy, string? sortDirection)
    {
