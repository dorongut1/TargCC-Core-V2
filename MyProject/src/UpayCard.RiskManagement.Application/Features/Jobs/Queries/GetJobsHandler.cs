...
namespace UpayCard.RiskManagement.Application.Features.Jobs.Queries;
...
public class GetJobsHandler : IRequestHandler<GetJobsQuery, Result<PagedResult<JobDto>>>
{
    ...
    public async Task<Result<PagedResult<JobDto>>> Handle(GetJobsQuery request, CancellationToken cancellationToken)
    {
        ...
        _logger.LogDebug("Getting Jobs - Page: {Page}, Size: {Size}, SortBy: {SortBy}", request.Page, request.PageSize, request.SortBy);
        ...
        try
        {
            ...
            _logger.LogDebug("Successfully retrieved {Count} of {Total} Jobs", dtos.Count, totalCount);
