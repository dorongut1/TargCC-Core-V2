...
/// </summary>
public class CreateSapHandler : IRequestHandler<CreateSapCommand, Result<int>>
{
    ...
    /// <inheritdoc/>
    public async Task<Result<int>> Handle(CreateSapCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("SAP created successfully with ID: {Id}", entity.Id);
