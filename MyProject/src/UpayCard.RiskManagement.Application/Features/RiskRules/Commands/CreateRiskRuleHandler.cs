...
/// </summary>
public class CreateRiskRuleHandler : IRequestHandler<CreateRiskRuleCommand, Result<int>>
{
    ...
    /// <inheritdoc/>
    public async Task<Result<int>> Handle(CreateRiskRuleCommand request, CancellationToken cancellationToken)
    {
