...
public class LoggedAlertRepository : ILoggedAlertRepository
{
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedJob>> Getc_LoggedJobsAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
