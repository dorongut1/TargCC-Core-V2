...
public class LoggedAlertRepository : ILoggedAlertRepository
{
    ...
    /// <inheritdoc/>
    public async Task<LoggedAlert?> GetByIdAsync(long id, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetAllAsync(int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task AddAsync(LoggedAlert entity, CancellationToken cancellationToken = default)
    {
        if (entity == null)
        {
    ...
    /// <inheritdoc/>
    public async Task UpdateAsync(LoggedAlert entity, CancellationToken cancellationToken = default)
    {
        if (entity == null)
        {
            throw new ArgumentNullException(nameof(entity));
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByCallingApplicationAsync(string callingApplication, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByDateOccurredAsync(DateTime dateOccurred, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByFaultNumberAsync(int faultNumber, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByenmFaultSeverity_FaultSeverityAsync(string enmFaultSeverity_FaultSeverity, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByenmFaultType_FaultTypeAsync(string enmFaultType_FaultType, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByenmFaultType_FaultTypeAndenmFaultSeverity_FaultSeverityAsync(string enmFaultType_FaultType, string enmFaultSeverity_FaultSeverity, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByc_LoggedLoginIDAsync(long c_LoggedLoginID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByMonthOccurredAsync(DateTime monthOccurred, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetBySystemNameAsync(string systemName, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByTimeOccurredAsync(DateTime timeOccurred, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByTimeOccurredAndenmFaultType_FaultTypeAndenmFaultSeverity_FaultSeverityAsync(DateTime timeOccurred, string enmFaultType_FaultType, string enmFaultSeverity_FaultSeverity, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedAlert>> GetByAffectedUserIDAsync(long affectedUserID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<LoggedJob>> GetLoggedJobsAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
        _logger.LogDebug("Fetching LOGGEDJOBS for LoggedAlert ID: {LoggedAlertId}", loggedAlertId);
        ...
        try
        {
            ...
            _logger.LogInformation("Retrieved {Count} LOGGEDJOBS for LoggedAlert ID: {LoggedAlertId}", result.Count(), loggedAlertId);

            return result;
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error fetching LOGGEDJOBS for LoggedAlert ID: {LoggedAlertId}", loggedAlertId);
            throw;
        }
    }

    /// <inheritdoc/>
    public async Task<IEnumerable<CardOrderFromIssuer>> GetCardOrderFromIssuersAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<ImportTransactionLoadRow>> GetImportTransactionLoadRowsAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<NewCardRequest>> GetNewCardRequestsAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<NewCardRequestAPI>> GetNewCardRequestAPIsAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<RequestedTransaction>> GetRequestedTransactionsAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetTransactionLoadsAsync(long loggedAlertId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
