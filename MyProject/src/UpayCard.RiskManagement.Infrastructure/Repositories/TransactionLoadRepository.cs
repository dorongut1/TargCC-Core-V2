...
public class TransactionLoadRepository : ITransactionLoadRepository
{
    ...
    /// <inheritdoc/>
    public async Task<TransactionLoad?> GetByIdAsync(long id, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetAllAsync(int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetFilteredAsync(long? requestedTransactionID = null, DateTime? day = null, long? distributorID = null, string? customerReference = null, decimal? amount = null, long? cardID = null, string? enmLoadType = null, string? enmLoadResult = null, string? enmCurrency = null, long? customerID = null, int? faultNo = null, long? loggedAlertID = null, DateTime? month = null, long? userID = null, DateTimeOffset? whenRequested = null, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task AddAsync(TransactionLoad entity, CancellationToken cancellationToken = default)
    {
        if (entity == null)
        {
    ...
    /// <inheritdoc/>
    public async Task UpdateAsync(TransactionLoad entity, CancellationToken cancellationToken = default)
    {
        if (entity == null)
        {
            throw new ArgumentNullException(nameof(entity));
    ...
    /// <inheritdoc/>
    public async Task<TransactionLoad?> GetByRequestedTransactionIDAsync(long requestedTransactionID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByDayAsync(DateTime day, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByDistributorIDAndCustomerReferenceAsync(long distributorID, string customerReference, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByAmountAsync(decimal amount, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByCardIDAsync(long cardID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByCardIDAndenmLoadTypeAndenmLoadResultAsync(long cardID, string enmLoadType, string enmLoadResult, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByenmCurrencyAsync(string enmCurrency, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByCustomerIDAsync(long customerID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByDistributorIDAsync(long distributorID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByFaultNoAsync(int faultNo, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByenmLoadResultAsync(string enmLoadResult, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByenmLoadTypeAsync(string enmLoadType, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByLoggedAlertIDAsync(long loggedAlertID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByMonthAsync(DateTime month, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByUserIDAsync(long userID, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<TransactionLoad>> GetByWhenRequestedAsync(DateTimeOffset whenRequested, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<BackofficeTransaction>> GetBackofficeTransactionsAsync(long transactionLoadId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<CardActivation>> GetCardActivationsAsync(long transactionLoadId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<ImportTransactionLoadRow>> GetImportTransactionLoadRowsAsync(long transactionLoadId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
