...
public class CustomerPerformanceRepository : ICustomerPerformanceRepository
{
    ...
    /// <inheritdoc/>
    public async Task<CustomerPerformance?> GetByIdAsync(long id, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<CustomerPerformance>> GetAllAsync(int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<CustomerPerformance>> GetFilteredAsync(long? customerID = null, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc/>
    public async Task AddAsync(CustomerPerformance entity, CancellationToken cancellationToken = default)
    {
        if (entity == null)
        {
    ...
    /// <inheritdoc/>
    public async Task UpdateAsync(CustomerPerformance entity, CancellationToken cancellationToken = default)
    {
        if (entity == null)
        {
            throw new ArgumentNullException(nameof(entity));
    ...
    /// <inheritdoc/>
    public async Task<CustomerPerformance?> GetByCustomerIDAsync(long customerID, CancellationToken cancellationToken = default)
    {
