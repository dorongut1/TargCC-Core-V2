...
public class CustomerRepository : ICustomerRepository
{
    ...
    /// <inheritdoc/>
    public async System.Threading.Tasks.Task<IEnumerable<Invoice>> GetInvoicesAsync(long customerId, int? skip = null, int? take = null, CancellationToken cancellationToken = default)
    {
        _logger.LogDebug("Fetching INVOICES for Customer ID: {CustomerId}", customerId);
        ...
        try
        {
            ...
            _logger.LogInformation("Retrieved {Count} INVOICES for Customer ID: {CustomerId}", result.Count(), customerId);

            return result;
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error fetching INVOICES for Customer ID: {CustomerId}", customerId);
            throw;
        }
    }
